 ...
 *     The final objective is to finish the implementation of a hashing and
 * verification system.
 *
 *     ------------------------------------------------------------------------------------------------------------------------------
 */
...
const char *init_message = "A hash function is a mathematical algorithm that "
                           "takes an input (or \"message\")\n"
                           "and returns a fixed-size string of bytes. The "
                           "output, often called the hash\n"
                           "value or hash code, is unique (within reason) to "
                           "the given input. In this lab,\n"
                           "we use the sha256 algorithm to compute the hash of "
                           "a given string or to verify\n"
                           "a signature.\n";
